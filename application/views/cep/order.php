    ...
    <div class="container">
        <div class="main-container">
            ...
            <div class="order-intro-frame">
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo base_url(); ?>/assets/img/product.jpg" class="img-responsive">
                    </div>
                    <div class="col-md-7">
                        <div class="cake-info">
                            <ul>
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="notice">
                                <ul class="list-unstyled">
                                    <li>即刻預購的蛋糕會統一在<span class="focus">6/19（四）</span>開始出貨<br></li>
                            ...
                            <div class="row mg10">
                                ...
                                <div class="form-group rec_a">
                                    ...
                                    <select class="form-control" name="rec_arrive_time[]" id="rec_arrive_time1">
                                        ...
                                        <option value="6/19(四)白天">6/19(四)白天</option>
                                        <option value="6/19(四)晚上">6/19(四)晚上</option>
                                        <option value="6/20(五)白天">6/20(五)白天</option>
                                        <option value="6/20(五)晚上">6/20(五)晚上</option>
                                        <option value="6/21(六)白天">6/21(六)白天</option>
                                        <option value="6/21(六)晚上">6/21(六)晚上</option>
                                        <option value="6/22(日)白天">6/22(日)白天</option>
                                        <option value="6/22(日)晚上">6/22(日)晚上</option>
                                        <option value="6/23(一)白天">6/23(一)白天</option>
                                        <option value="6/23(一)晚上">6/23(一)晚上</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mg10">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="subscriber-info">
                                        <div class="row mg10">
                                            <div class="get-receiver">
                                                <input type="checkbox" name="get-receiver-checkbox" id="get-receiver-checkbox">
                                                <label for="get-receiver-checkbox" class="get-receiver-label" data-toggle="tooltip" data-placement="right" title="預設採用第一位收貨人">同收貨人</label>
                                            </div>
                                        </div>
                                        <div class="row mg10">
                                            <div class="form-group">
