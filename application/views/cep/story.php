    <body>
        ...
        <div class="container">
            <div class="main-container">
                ...
                <div class="story-frame first">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="title">
                                <img src="<?php echo base_url(); ?>/assets/img/Story_title1.png" class="img-responsive">
                            </h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="subtitle">
                                我們是一群來自台大創意創業學程的學生，憑著一股傻勁，嘗試各種改變世界的可能。
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="story-foot-text">
                                我們誠摯邀情您，一同參與台灣最美味的群眾募資。<br>台大創意創業學程，看見學生對公益的想像力！
                            </div>
                        </div>
                    </div>
                </div>
                <div class="story-frame second">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="title">
                                <img src="<?php echo base_url(); ?>/assets/img/Story_title2.png" class="img-responsive">
                            </h2>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="story-foot-text">
                                我們目前仍然在積極籌措全村永久屋的內裝費用，<br> 也希望之後將哈凱改造成為一個藝術村，帶動部落的永續發展。<br>
                                <span class="strong">哈凱部落離家不遠的最後一哩路，需要您的幫助。</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="story-frame third">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="title">
                                <img src="<?php echo base_url(); ?>/assets/img/Story_title3.png" class="img-responsive">
                            </h2>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="pic">
                                        <img src="<?php echo base_url(); ?>/assets/photo/Story_picture3.jpg" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="intro">
